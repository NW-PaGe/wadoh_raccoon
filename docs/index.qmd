...
pyodide:
    packages:
        - https://nw-page.github.io/wadoh_raccoon/articles/wadoh_raccoon-0.4.0-py3-none-any.whl
        - polars
---
...
# apply the function
df.with_columns(new_date=helpers.date_format(df=df,col='old_date'))
...
helpers.gt_style(
    df
    .with_columns(
        new_date=helpers.date_format(df=df,col='old_date')
    )
)
```
