...
| Name | Description |
| --- | --- |
| [__delete](#src.wadoh_raccoon.utils.azure.__delete) | Delete |
...
### __delete { #src.wadoh_raccoon.utils.azure.__delete }
...
<code>[**client**]{.parameter-name} [:]{.parameter-annotation-sep} [ContainerClient]{.parameter-annotation}</code>
